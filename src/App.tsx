...
import { listTools, listProyek } from './data.ts';
    ...
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-1s">
          ...
          <h1 className="text-5xl/tight font-bold mb-6">Hi, saya Inov Afani</h1>
          <p className="text-base/loose mb-6 opacity-50">
            Saya mempunyai ketertarikan dalam bidang programming, terutama dalam
            pembuatan website. Ketertarikan ini sudah berlangsung lebih dari 1
            tahun untuk saya
          </p>
      ...
      <div className="tentang mt-32 py-10" id="tentang">
        ...
        >
          ...
          <p className="text-base/loose mb-10">
            Hi, perkenalkan saya INov AFani, seorang Full Stack Web Developer
            dan Designer UI/UX Design. Saya percaya bahwa design dan
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {proyek.tools.map((tool, index) => (
                    <p
                      className="py-1 px-3 border border-zinc-500 bg-zinc-500 rounded-md font-semibold"
                      key={index}
                    >
                      {tool}
                    </p>
      ...
      <div className="kontak mt-32 sm:p-10 p:0" id="kontak">
        ...
        <form
          ...
          autoComplete="off"
          action="https://formsubmit.co/inoveka@gmail.com"
          method="POST"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-delay="500"
